...
function FG_UI_CollectorInfoPanel:createChildren()
    ...
    local iconDesc = getText("IGUI_panel_FunctionalGutters_section_Roof_icon_tooltip_success")
    ...
    iconDesc = getText("IGUI_panel_FunctionalGutters_section_Pipes_icon_tooltip_success")
    ...
    iconDesc = getText("IGUI_panel_FunctionalGutters_section_Collector_icon_tooltip_success")
...
function FG_UI_CollectorInfoPanel:prerender()
    ...
    if self.isInvalid then
        ...
        local text = getText("IGUI_panel_FunctionalGutters_section_Collector_invalid_MissingCollector")
        c = self.textColor
    ...
    if self.fluidIconPanel.icon ~= icon then
        ...
        local tooltipText = getText("IGUI_panel_FunctionalGutters_section_Roof_icon_tooltip_"..endText)
    ...
    if self.plumbIconPanel.icon ~= icon then
        ...
        local tooltipText = getText("IGUI_panel_FunctionalGutters_section_Pipes_icon_tooltip_"..endText)
    ...
    if self.collectorIconPanel.icon ~= icon then
        ...
        local tooltipText = getText("IGUI_panel_FunctionalGutters_section_Collector_icon_tooltip_"..endText)
...
function FG_UI_CollectorInfoPanel:new(x, y, _player, _gutterDrain, _collector)
    ...
    o.containerInfo = {
        ...
        baseRainFactor = { tag = getText("IGUI_panel_FunctionalGutters_section_Collector_item_BaseRainFactor")..": ", value = "0.0", cache = 0.0 },
        totalRainFactor = { tag = getText("IGUI_panel_FunctionalGutters_section_Collector_item_TotalRainFactor")..": ", value = "0.0", cache = 0.0 },
    }
