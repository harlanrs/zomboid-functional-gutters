...
local function loadModOptions()
    ...
    options.roofRainFactorOption = modOptions:addSlider(enums.options.roofRainFactor,
        getText("IGUI_options_FunctionalGutters_" .. enums.options.roofRainFactor), 0.0, 2.0, 0.1, 1.0,
        getText("IGUI_options_FunctionalGutters_" .. enums.options.roofRainFactor .. "_tooltip"))

    -- NOTE: slider option doesn't appear to display the tooltip so including it again as a description
    modOptions:addDescription(getText("IGUI_options_FunctionalGutters_" .. enums.options.roofRainFactor .. "_tooltip"))

    -- NOTE: will eventually need to be a sandbox option for multiplayer
    options.requireWrench = modOptions:addTickBox(enums.options.requireWrench,
        getText("IGUI_options_FunctionalGutters_" .. enums.options.requireWrench), true,
        getText("IGUI_options_FunctionalGutters_" .. enums.options.requireWrench .. "_tooltip"))

    options.debugOption = modOptions:addTickBox(enums.options.debug,
        getText("IGUI_options_FunctionalGutters_" .. enums.options.debug), false,
        getText("IGUI_options_FunctionalGutters_" .. enums.options.debug .. "_tooltip"))
end
